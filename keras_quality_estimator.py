...
LEARNING_RATE = 5e-08  # 5e-08, 5e-07
BATCH_SIZE = 20
EPOCHS = 50
...
for i in range(1, CROSS_VAL + 1):
    ...
    with run:
        ...
        if FEATURE_TYPE == 'embeddings-ge2e':
            ...
            model.add(Bidirectional(LSTM(256, input_shape=(50, 50), return_sequences=False), merge_mode='concat'))  # first 50 is timesteps, second 50 is length of features
