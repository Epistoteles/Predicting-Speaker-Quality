...
# TRILL embeddings LSTM  learning rate 5e-8, Dropout 0.5, Batch size 50,
...
plt.text(6, 0.1569 - 0.005, f"true 'random guessing' baseline: 0.01569", color='red', horizontalalignment='center', fontsize=8)
